...
{{ blog.rss_link }}
   ...
   * html #content_left {
     ...
     filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(enabled=true, sizingMethod=scale, src='{{images_path}}/content.png');
    }
          ...
          <table>
            <tr>
              ...
              <td>
                ...
                {{ article.excerpt }}
                <br /><a href="{{ article.url }}">{{ "read_more" | lc }}</a>, <a href="{{ article.url }}#comments">{{ "comments_for_count" | lc}}: {{ article.comments_count }}</a>
              </td>
            </tr>
          </table>
        </div> <!-- //blog -->

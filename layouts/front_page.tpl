...
{% include "SiteHeader" %}
  <style type="text/css">
    * html #front #cont_front {
      background: none;
    filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(enabled=true, sizingMethod=crop, src='{{images_path}}/bird.png');
    }
    * html #langmenu { position: relative;}
...
<div id="darkcontent_wrap">
      ...
      <div id="darkcontent_inner" class="clearfix">
        {% content %}
